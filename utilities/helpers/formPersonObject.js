...
exports.formPersonObjects = async ( obj ) => {
    ...
    const page = await puppeteerBrowser.goToObjectPage( priceDataWithUrl.sourceURLs.find( ( el ) =>
        el.includes( 'amazon.com' ) ) );
...
const formAuthors = async ( authors, obj ) => {
    ...
    for ( const author of authors ) {
        if ( _.get( author, 'asin' ) ) {
            ...
            obj.fields = obj.fields ? obj.fields.push( field ) : [ field ];
        }
    }
